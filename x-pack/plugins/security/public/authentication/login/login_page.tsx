...
import vivekSVG from '../../../../../../src/core/server/core_app/assets/images/logoFull.png';
...
const infoMessageMap = new Map([
  ...
  [
    ...
    i18n.translate('xpack.security.login.loggedOutDescription', {
      defaultMessage: 'You have logged out of Amberoon Lucre.',
    }),
  ],
]);
        ...
        <header className="loginWelcome__header">
          <div className={contentHeaderClasses}>
            ...
            <span className="loginWelcome__logo">
              <EuiIcon type={vivekSVG} size="xxl" />
            </span>
            <EuiTitle size="m" className="loginWelcome__title">
              <h1>Welcome to Amberoon Lucre
              </h1>
            </EuiTitle>
            <EuiSpacer size="xl" />
          </div>
