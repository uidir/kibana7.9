...
export const Template: FunctionComponent<Props> = ({
  ...
  const logo = ( <image src={`${uiPublicUrl}/images/Logo-DNA.svg`} height="60" width="60" />
 );
  return (
    <html lang={locale}>
      <head>
      ...
      <body>
        ...
        >
          <div className="kbnLoaderWrap">
            ...
            >
              {i18n('core.ui.welcomeMessage', { defaultMessage: 'Loading Amberoon Lucre' })}
            </div>
